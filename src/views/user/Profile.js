			...
			<Grid item xs={12} md={6}>
				...
				<Box component={Paper} sx={{ p: 2, mb: 2 }}>
					...
					<Typography
						...
						color="gray"
					>
						Buy more credits with following pre-defined amounts. New
						credits will be added in your existig balance.
					</Typography>
					<Box
						sx={{
							mt: 1,
				...
				<Box component={Paper} sx={{ p: 2 }}>
					...
					<Typography
						...
						color="gray"
					>
						With monthly subscription you'll be purchasing credits
						for {Utils.formatToCurrency(subAmount, "$")} every month
						and get a lot of extra benefits and free searches.
					</Typography>
					<Button
