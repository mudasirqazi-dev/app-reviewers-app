...
function History() {
  ...
  const emptyRows1 =
    page1 > 0 ? Math.max(0, (1 + page1) * rowsPerPage1 - history.length) : 0;
                  ...
                  <TableBody>
                    {(rowsPerPage > 0
                      ...
                      >
                        ...
                        <TableCell component="td" scope="row" align="right">
                          {Utils.formatToNumber(row?.count)}
                        </TableCell>
                        ...
                        <TableCell component="td" scope="row" align="center">
                          ...
                          >
                            <Button
                              ...
                              color="grey"
                              size="small"
                              onClick={() => setHistory(row?.results)}
                              icon={<Search />}
                              style={{
                                height: "auto",
                              }}
                            ...
                            <Button
                              ...
                              size="small"
                              onClick={() => {
                                setResearchKeywords(row?.keyword);
                ...
                <Table size="small">
                  ...
                  <TableBody>
                    {(rowsPerPage1 > 0
                      ...
                      >
                        <TableCell component="td" scope="row" align="left">
                          {row?.username} ({row?.contacts?.length})
                        </TableCell>
                        <TableCell component="td" scope="row" align="left">
                          {row?.country}
                        </TableCell>
